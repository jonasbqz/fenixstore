...
export function FireIcon({ className = "h-4 w-4" }: { className?: string }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
      <path d="M12 23c-4.97 0-9-4.03-9-9 0-3.53 2.04-6.8 5.19-8.41.42-.21.93-.05 1.15.37.17.33.12.74-.13 1.02-1.78 1.95-2.21 4.79-1.05 7.15 1.15 2.36 3.65 3.87 6.27 3.87s5.12-1.51 6.27-3.87c1.16-2.36.73-5.2-1.05-7.15-.25-.28-.3-.69-.13-1.02.22-.42.73-.58 1.15-.37C19.96 7.2 22 10.47 22 14c0 4.97-4.03 9-9 9zm-1.5-6.5c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5-.67 1.5-1.5 1.5-1.5-.67-1.5-1.5z" />
    </svg>
  );
}
...
export function UnlockIcon({ className = "h-4 w-4" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export function CrosshairIcon({ className = "h-4 w-4" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
